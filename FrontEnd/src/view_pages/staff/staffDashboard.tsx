...
const Dashboard: React.FC = () => {
  ...
  // Sample data for Recent Tenancy Changes
  const recentTenancyChanges = [
    { id: 1, name: "John Smith", startDate: "2025-09-13", roomNumber: "Room 123", status: "Active" },
    { id: 2, name: "John Wick", startDate: "2025-09-12", roomNumber: "Room 321", status: "Active" },
    { id: 3, name: "John Cena", startDate: "2025-09-11", roomNumber: "Room 231", status: "Active" },
    { id: 4, name: "John John", startDate: "2025-09-10", roomNumber: "Room 456", status: "Active" },
  ];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0 pl-64">
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-auto space-y-6">
          ...
          {/* Row 1: Recent Tenancy Changes + Quick Actions */}
          <div className="grid lg:grid-cols-2 gap-6">
            {/* Recent Tenancy Changes Card */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-lg font-semibold text-gray-800">Recent Tenancy Changes</h2>
                  <p className="text-sm text-gray-500">Latest updates to tenant assignments</p>
                </div>
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-gray-600 mt-1">Space Occupied</span>
                </div>
              </div>

              {/* Tenant List */}
              <div className="space-y-3">
                {recentTenancyChanges.map((tenant) => (
                  <div key={tenant.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Started {tenant.startDate}</p>
                      </div>
                    </div>
